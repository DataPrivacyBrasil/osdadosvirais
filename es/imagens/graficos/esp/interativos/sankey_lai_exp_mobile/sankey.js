async function draw() {
  ...
  const links = await d3.csv("https://docs.google.com/spreadsheets/d/e/2PACX-1vQq4GCKf_GrJ8Uv6ndvPDj4cxDU2WAKXGmnAei4aXBtSBXapdCdPwv6QWmivMpzRLCQr5BXkimBcrT-/pub?gid=1767314888&single=true&output=csv");
  links.map(l => {
    l.value = +l.value;
    l.count = +l.count;
  });
